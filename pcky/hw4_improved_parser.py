...
# USAGE: hw4_improved_parser.sh <input_PCFG_file> <test_sentence_filename> <output_parse_filename>
# Example: export dataDir=~/dropbox/17-18/571/hw4/data
#	sh hw4_parser.sh hw4_trained.pcfg $dataDir/sentences.txt parses_base.out
# 	sh hw4_parser.sh hw4_trained.pcfg $dataDir/toy_sentences.txt toy_output.txt
...
if len(sys.argv) > 1:
	...
	print("USAGE: <input_PCFG_file> <test_sentence_filename> <output_parse_filename>")
	exit()
...
inputCFG = nltk.PCFG.fromstring(inStr)
